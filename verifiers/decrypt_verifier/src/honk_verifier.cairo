...
use super::honk_verifier_circuits::{
    is_on_curve_excluding_infinity_bn254, run_GRUMPKIN_ZKHONK_PREP_MSM_SCALARS_SIZE_13_circuit,
    ...
    run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_13_PUB_24_circuit,
};
...
mod UltraKeccakZKHonkVerifier {
    ...
    use super::{
        ...
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_INIT_SIZE_13_circuit,
        run_GRUMPKIN_ZK_HONK_EVALS_CONS_LOOP_SIZE_13_circuit,
        run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_13_PUB_24_circuit, vk,
    };
    ...
    impl IUltraKeccakZKHonkVerifier of super::IUltraKeccakZKHonkVerifier<ContractState> {
        fn verify_ultra_keccak_zk_honk_proof(
            ...
            let (sum_check_rlc, honk_check) = run_GRUMPKIN_ZK_HONK_SUMCHECK_SIZE_13_PUB_24_circuit(
            ...
            let mut scalars: Span<u384> = array![
                ...
                scalar_51, scalar_52, transcript.shplonk_z.into(), scalar_53,
            ]
                .span();

            // Check input points are on curve.
            // Skip the first 28 points as they are from VK and keep the last 25 proof points
            for point in points.slice(28, 25) {
                assert(
